...
const Button = memo(({ 
  ...
  const variants = {
    ...
    secondary: 'bg-[#23263a] hover:bg-[#31344d] text-white border border-[#31344d] hover:border-[#31344d]/80 focus:ring-[#01C38D]/20',
    ...
    minimal: 'text-gray-300 hover:text-white hover:bg-[#23263a] focus:ring-[#01C38D]/20'
  };
