    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-40 flex items-start justify-center p-4 pt-24">
      <div className="bg-[#171717] border border-[#262626] rounded-2xl p-8 max-w-md w-full text-center shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            to="/login"
            className="flex-1 bg-[#01C38D] hover:bg-[#01A071] text-[#232323] font-bold px-6 py-3 rounded-lg transition-all duration-200 transform hover:scale-105"
          >
            Entrar
          </Link>
          <Link
            to="/signup"
            className="flex-1 bg-[#171717] hover:bg-[#262626] text-white border border-[#262626] font-bold px-6 py-3 rounded-lg transition-all duration-200 transform hover:scale-105"
          >
            Criar Conta
          </Link>
        </div>
