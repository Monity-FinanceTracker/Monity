...
function Transactions() {
    ...
    return (
        <div className="p-4 md:p-6 rounded-xl mt-4 md:mt-8 mx-auto max-w-5xl">
            ...
            <span className={`text-white mr-3 font-semibold ${choice ? 'text-[#56a69f]' : 'text-gray-400'}`}>{t('transactionsPage.expenses')}</span>
            ...
            <span className={`text-white ml-3 font-semibold ${!choice ? 'text-[#56a69f]' : 'text-gray-400'}`}>{t('transactionsPage.incomes')}</span>
            </div>
